...
const CONTENT = {
  ...
  // Вкладка "В веселье"
  fun: {
    introText: "Ты весёлый даже когда не пьян, твоя улыбка это нечто! Пусть она также будет оставаться яркой и святить нам вместо солнца. Пусть этот день принесёт тебе такую же улыбку как и тогда!",
    slides: [
  ...
  // Вкладка "Семья"
  love: {
    introText: "Семья - это самое главное в жизни. Да бывают моменты когда мы тебя не поймём, но всегда поддержим. И пусть эти моменты согревают твое сердце! Мы любим тебя папа!",
    slides: [
